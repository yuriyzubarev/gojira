        ...
        (let [sprint-issues (get-sprint-issues! (:sprint opts) opts)]
            ...
            (cond
                ...
                (= "by-status" (first args))    (do 
                                                    ...
                                                    (println "<h3>In dev</h3>")
                                                    (println (html-table-top))
                                                    (print-sprint-snapshot! (filter #(= "In Progress" (:status %)) sprint-issues) format-issue-map-as-html)
                                                    (println "</table>")
                                                    (println "<h3>In test</h3>")
                                                    (println (html-table-top))
                                                    (print-sprint-snapshot! (filter #(= "In Test" (:status %)) sprint-issues) format-issue-map-as-html)
                                                    (println "</table>")
